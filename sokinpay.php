 ...
 */
define('WOO_CUSTOM_PAYMENT', '1.1.0');
...
function register_sokinpay_gateway_styles() {
	wp_register_style('sokinpay_gateway_style', plugin_dir_url(__FILE__) . 'assets/css/style.css', array(), '1.1.0', 'all');
...
function register_sokinpay_gateway_scripts($hook) {
	wp_register_script('sokinpay_gateway_js', plugin_dir_url(__FILE__) . 'includes/js/woo_cpay_js.js', array(), '1.1.0', array('in_footer' => true));
